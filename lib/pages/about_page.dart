          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromARGB(255, 22, 132, 199),
                  Color.fromARGB(255, 118, 214, 29)
                ], // Gradien warna biru
              ...
              children: [
                ...
                const CircleAvatar(
                  ...
                  backgroundImage: AssetImage(
                      "assets/images/renal_cool.png"), // Path to your profile picture
                  backgroundColor: Colors
                      .white, // Warna latar belakang jika gambar tidak dimuat
                ),
                const SizedBox(height: 20),

                // Nama
                Text(
                  "Renaldy Azhari Imaduddin",
                  style: TextStyle(
                    fontSize: 28,
                    fontWeight: FontWeight.bold,
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        InkWell(
                          onTap: () => _launchURL('tel:+6289630633269'),
                          child: Row(
                        ...
                        const SizedBox(height: 10),
                        InkWell(
                          onTap: () => _launchURL('mail to :2106020@itg.ac.id'),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: const [
